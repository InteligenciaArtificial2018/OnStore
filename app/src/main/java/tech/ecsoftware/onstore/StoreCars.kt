...
class StoreCars : AppCompatActivity(), CarsAdapter.OnProductItemClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        carsAdapter = CarsAdapter(storeDatabase?.getProductosDBDao()?.getProductList())
        carsAdapter?.setProductItemClickListener(this)
    ...
    override fun onResume() {
        super.onResume()
        carsAdapter?.productList = storeDatabase?.getProductosDBDao()?.getProductList()
        rvProduct.adapter = carsAdapter
